...
<div class="field"><i data-lucide="layers"></i><label>Item Type *</label>
<select id="modal-type" ${readonly?'disabled':''}><option>Raw Material</option>
<option>Semi Product</option><option>Finish Product</option><option>Wastage</option>
<option>Scrap</option><option>Consumable</option>
</select></div><div class="field"><i data-lucide="boxes">
