...
use App\Http\Controllers\Api\V1\FinishedProductStockSummaryController;
...
Route::prefix('v1')->group(function (): void {
    ...
    Route::middleware('auth:sanctum')->group(function (): void {
        ...
        Route::get('/finished-product-stock-summary/export', [FinishedProductStockSummaryController::class, 'export'])->middleware('permission:overall-stock-summary.view');
        Route::get('/finished-product-stock-summary/import-template', [FinishedProductStockSummaryController::class, 'importTemplate'])->middleware('permission:overall-stock-summary.view');
        Route::post('/finished-product-stock-summary/import', [FinishedProductStockSummaryController::class, 'import'])->middleware('permission:overall-stock-summary.view');
        Route::get('/finished-product-stock-summary/history', [FinishedProductStockSummaryController::class, 'history'])->middleware('permission:overall-stock-summary.view');
        Route::get('/finished-product-stock-summary', [FinishedProductStockSummaryController::class, 'index'])->middleware('permission:overall-stock-summary.view');
